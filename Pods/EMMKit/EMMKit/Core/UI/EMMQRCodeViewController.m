...
@implementation EMMQRCodeViewController
...
- (void)viewDidLoad {
    ...
    switch (self.scannerType) {
        case EMMQRCodeScannerTypeBoth:
            metadataObjectTypes = @[AVMetadataObjectTypeQRCode,
                                    AVMetadataObjectTypeEAN13Code,
                                    AVMetadataObjectTypeEAN8Code,
                                    AVMetadataObjectTypeCode128Code];
        break;
        case EMMQRCodeScannerTypeQRCode:
            metadataObjectTypes = @[AVMetadataObjectTypeQRCode];
        break;
        case EMMQRCodeScannerTypeBarCode:
...
- (void)captureOutput:(AVCaptureOutput *)captureOutput didOutputMetadataObjects:(NSArray *)metadataObjects fromConnection:(AVCaptureConnection *)connection {
    ...
    //输出扫描字符串
    [self.delegate emm_QRCodeViewController:self didFinishScanningQRCode:metadataObject.stringValue];
}
